        ...
        <div class="profile"style="    background-color: rgba(1, 1, 23, 0.714);">
            ...
            <div class="profile__banner">
                ...
                <div class="dt-page__header">
                    ...
                    Withdrawals                    </h1>
                                                                    <a href="" class="btn btn-light btn-sm display-i ft-right"> Approved:  USD   {{ DB::table('withdrawals')->where('status','paid')->sum('amount') }} </a>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="display-3 font-weight-600 mb-1 init-counter">
                                                  @if (count($deposits)>0)       
          {{ DB::table('withdrawals')->where("user_id",$user->id)->where('status','pending')->sum('amount') }} USD
			                                 </p>
                                             @else
                                             <h2>00</h2>
                                             @endif
                            ...
                            <div class="col-sm-6 col-12">
                                ...
                                <div class="dt-card dt-card__full-height text-dark">
                                         @if (count($deposits)>0)
											...
											{{ DB::table('deposits')->where("user_id",$user->id)->where('status','approved')->sum('amount') }} USD
