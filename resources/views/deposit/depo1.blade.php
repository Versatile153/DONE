            ...
            <div class="profile__banner">
                ...
                <div class="dt-page__header">
                    <h1 class="dt-page__title text-light display-i">Deposits/New deposit</h1>
                                        <a href="" class="btn btn-light btn-sm display-i ft-right"> hey {{Auth::user()->name}}</a>
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-12">
                              ...
                              Thank you for trusting in                                        </div>
                                                <span class="d-block">
                                                 primewaretrades                                               </span>
                                            </div>
                                            <!-- /media body -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                                ...
                                                <div class="form-group mb-0 ">
                                                    <button style="" id="next" class="btn btn-info text-uppercase ml-5 ">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <input required type="radio" name="payment_method"
                                                                        value="btc" /><img style=" width: 60px;"
                                                                        src="https://imgs.search.brave.com/rxwtYTP3sZnSOC14EkdRtLVTYowVZ8QaFhiAtPhER5I/rs:fit:439:225:1/g:ce/aHR0cHM6Ly90c2Uy/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5C/UlEwQWstXzB6U0sw/enpXVDJzWllnSGFI/XyZwaWQ9QXBp"
                                                                        alt="Select payment method"
                                                                        class="selected_img">
                                                                </div>
                                                                                                                                <div class="cnt_min col-md-2">
                                                                    <input required type="radio" name="payment_method"
                                                                        value="eth" /><img style=" width: 60px;"
                                                                    ...
                                                                    <input type="radio" name="payment_method"
                                                                        value="ussdt" /><img style=" width: 60px;"
