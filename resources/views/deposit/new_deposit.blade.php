            ...
            <div class="profile__banner">
                ...
                <div class="dt-page__header">
                    ...
                    <div style="display:flex;">
                        ...
                        <div>
                             <button style="width:120px;" id="copyBtn" data-text="bc1qu80lfkeunf99lwn5epdplu3tk060s55cv3pekk">Copy btc address</button>
                ...
                <script>
                 ...
                 if(document.execCommand('copy')) {
                  ...
                  document.body.removeChild(input);
                            ...
                            <div>
                             <button style="width:120px;" id="copyBtn1" data-text="OxF5528ae8DOF1988a9Ea171505F94b37E94308dd4">ussdt address</button>
                ...
                <script>
                 ...
                 if(document.execCommand('copy')) {
                  ...
                  document.body.removeChild(input);
                             ...
                             <button style="width:120px;" id="copyBtn2" data-text="bc1qu80lfkeunf99lwn5epdplu3tk060s55cv3pekk">Copy eth address</button>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <div class="display-3 font-weight-600 mt-1 init-counter">
                                                    <a href=""> referal code {{$user->refferal_code}}</a>
                                                    </div>
                        ...
                        <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                   <h2 style="color:gray;">Recipient Addresses</h2>
...
<input type="hidden" name="csrf_test_name" value="" />    
 @csrf   
                                        <div class="form-group">
                                            <label>Enter transaction id you've sent the deposit from</label>
