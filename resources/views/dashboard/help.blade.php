...
<head>
 ...
 <style>
  ...
  <div  class="">
    ...
    </head>    <body class="dt-header--fixed theme-dark dt-layout--full-width dt-sidebar--fixed o-auto">
        <!-- Root -->
...
<img class="flag-icon flag-icon-rounded flag-icon-lg mr-2" src="https://primestocktrades.com/m_cust/dash/uploads/germany.png"><span>German</span> </button>
                ...
                <!-- Site Main -->
                <main class="dt-main" style="background-color: rgba(0, 0, 22, 0.714);">
                    <!-- Sidebar -->
                                ...
                                <div class="border-bottom border-w-2 mb-1 mt-n1 pb-4 px-1">
                                    ...
                                    <div role="group" class="btn-group btn-group-sm mr-4 mr-lg-7 mb-1 ng-star-inserted">
                                        ...
                                        <div x-placement="bottom-right" data-url="" class="dropdown-menu bulk-priority" style="">
                                            ...
                                            <a href="javascript:void(0)" data-id="low" class="prioritise-table dropdown-item ng-star-inserted">Low priority</a>
                                        </div>
                                    </div><!---->
                                    <div placement="bottom-right" style="margin-right:2.3rem;" class="dropdown">
                                        <a aria-haspopup="true" id="bulk-action" href="javascript:void(0)" class="dropdown-toggle btn btn-outline-dark btn-sm" aria-expanded="false"> Status </a>
                                        <div class="bulk-action dropdown-menu" data-url="
                                        ">
                                            <a href="javascript:void(0)" data-id="0" class="resolve-table dropdown-item">P withdrwal:	{{ DB::table('withdrawals')->where('status','pending')->sum('amount') }} USD</a>
                                            <a href="javascript:void(0)" data-id="1" class="resolve-table dropdown-item">T withdrawal:	{{ DB::table('withdrawals')->where('status','paid')->sum('amount') }} USD</a>
  ...
  <div class="section">
    <div class="container mb-5">
        <div class="support-container container text-light">
            <h4>Help/Support</h4>
            <div class="support-text text-center mb-5">
            At PrimewareTrades, we are dedicated to making our customers happy. If you have a question or concern,
you've come to the right place. Use any of the options below to get issues resolved.
Our Channels are available 24/7.
            ...
            <div class="support-options">
                    <div class="option">
                        <h4>Live Chat</h4>
                        <div>
                            <p>Chat with an agent and get your issues resolved instantly. Available 24/7.</p>
                        </div>
                        
                         <a href="https://t.me/primewaretrades">
                               <button class="btn btn-sm">Start Chart</button>
                         </a>
                      
                    </div>
                    <div class="option">
                        <h4>Faq</h4>
                        <div><p>Go through our Frequently Asked Questions.</p></div>
                       
                        <a href=" https://instagram.com/primewaretrades?igshid=YmMyMTA2M2Y=" class="btn btn-sm">See FAQ</a>
                    </div>

                    <div class="option">
                        <h4>Phone Call</h4>
                        <div class="k"><p>Would you rather talk to a support agent over the phone? Then call us on <span id="phone">070672714</span></p></div>
                        <button id="copy_number" class="btn btn-sm" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="Top popover">Copy Number</button>
                    </div>
            </div>
        </div>
    </div>
    ...
    let copyBtn = document.getElementById('copy_number')
