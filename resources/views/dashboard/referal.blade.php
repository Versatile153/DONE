                                    ...
                                    <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="display-3  mb-1 init-counter">
                                                    ref code {{$user->refferal_code}}                                                </div>
                                                <span class="d-block">
                                ...
                                <div class="dt-card dt-card__full-height text-dark">
                                    ...
                                    <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4">
                                        ...
                                        <p class="mb-1 h1 text-dark">
											{{ DB::table('deposits')->where('status','approved')->sum('amount')* 0.0000000000000111 }} USD
			                                 </p>
                                             @else
                                             <h2>00</h2>
                                             @endif                                              </div>
                            ...
                            <div class="dt-card__body">
                                ...
                                <div class="table-responsive dataTables_wrapper dt-bootstrap4">
                                    <div class="table-responsive">
                                        ...
                                        <span class="d-block">
                                            ...
                                            <h1>{{count($proof)}} recorded transactions</h1>
                                        </div>
                                                                            </div>
                                    <!-- /tables -->
                                ...
                                <div class="tradingview-widget-container mb-1-5m">
                                    ...
                                    <table class="table table-ordered table-bordered-0 mb-0 ml-2">
                                        <thead>
                                            <tr>
                                                <th class="text-uppercase">TXN id Code</th>
                                                <th class="text-uppercase text-right" scope="col">trx_id hash
                                                </th>
                                        ...
                                        <tbody>
                                                ...
                                                @if(count($proof)>0) 
                                                                                           @foreach($proof as $depo)   
                                                                                       <tr>
                                                                                         
                                                <td>{{$depo->id}}</td>
                                          
                                                <td style="color:black;">  <a style="color:black;" href="{{$depo->trx_id}}">{{$depo->trx_id}}</td></a>
                                                <td style="color:black;"> {{$depo->created_at}}                                               </td>
