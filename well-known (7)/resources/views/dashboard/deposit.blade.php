                                ...
                                <li
                                    ...
                                    <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow"
                                        ...
                                        <i class="icon icon-revenue-new icon-fw icon-lg"></i><span
                                            class="dt-side-nav__text">Deposit</span> </a>
                                    ...
                                    <ul class="dt-side-nav__sub-menu display-b">
                                        ...
                                        <li class="dt-side-nav__item">
                                            <a href="view_deposit"
                                                ...
                                                title="Revenue">
                                                <span class="dt-side-nav__text">View Deposit</span> </a>
                                        </li>
                                    </ul>
                                    <!-- /sub-menu -->
        ...
        <div class="profile">
            ...
            <div class="profile__banner">
                ...
                <div class="dt-page__header">
                    ...
                    Deposits                    </h1>
                                                                    <a href="" class="btn btn-light btn-sm display-i ft-right">Make a deposit</a>
                            ...
                            <div class="modal fade display-n" id="pricemodal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <!-- Modal Body -->
                                        <div class="modal-body">
                                            <p>deposit Amount: <b id="fullamount"></b></p>
