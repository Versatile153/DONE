...
#hero {
  width: 100%;
  height: 80vh;
  background: url(img/Career1.png) top center;
  ...
  <header id="header" class="d-flex align-items-center ">
    <div class="container-fluid container-xxl d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto" href="/story">Company</a></li>
          <li><a class="nav-link scrollto active" href="/career">Careers</a></li>
          <li><a class="nav-link scrollto" href="/register">Register</a></li>
        </ul>
        <i class="bi bi-list mobile-nav-toggle"></i>
      </nav><!-- .navbar -->
      <a class="buy-tickets scrollto" href="/">Primewaretrades</a>
                                        ...
                                        <div class="dis-flex inner-container  ">
                                            ...
                                            <div class="right-text">
                                                <div class="detail-content" data-aos="fade-up" data-aos-delay="300" data-aos-duration="700">
                                                    <p>Are you an open-minded, out-of-the-box thinker with bucketloads of enthusiasm and an incredible skillset? Join the Primewaretrades family and contribute to our mission.&nbsp;</p>
                                                    <p>At Primewaretrades, we have a progressive perspective of the world and the issues that impact on human sovereignty and sustainability. With a shared goal of providing the tools and technology to aid a positive change, we pool our talents and skills to bring this about.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="hs_cos_wrapper_widget_1623689987812" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                                <div class="two-col-form">
                                  ...
                                  <form  role="form" class="php-email-form">
                                    ...
                                    <div style="background:gray;"  class="text-center"><button class"btn btn-primary" type="submit">Send Message</button></div>
                                  </form>
                                </div>
                                ...
                                <div class="two-col-image">
                                    <div class="container">
                                        <div class="two-col-image-flex">
                                            ...
                                            <div class="two-col-image-left" style="background-image:url(https://www.gravity.eco/hubfs/Website%20Assets/Career2.png);" data-aos="zoom-in" data-aos-duration="700"></div>
                                            <div class="two-col-image-right" style="background-image:url(https://www.gravity.eco/hubfs/Website%20Assets/Career3.png)" data-aos="zoom-in" data-aos-duration="700" data-aos-delay="100"></div>
