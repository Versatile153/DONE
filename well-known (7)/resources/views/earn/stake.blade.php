...
<div class="cover hide"></div>    
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-up" data-aos-delay="150">
      ...
      <div class="d-flex">
        <a href="/register" class="btn-get-started scrollto">Stake Now</a>
      </div>
    </div>
    ...
    <div id="section1" class="container default-wd mobile-padding-top1">
        <div class="title">
        <h2><p class="hidden-xs" style="padding-bottom:5px;font-size:28px; text-align:center;font-weight:600;">Stake with Primewaretrades Trading Limited</p></h2>
        </div>
        ...
        <div class="row fb-cus-row">
            ...
            <div class="text-block1"><p>Staking cryptocurrencies is a great way to diversify your portfolio and hedge risks. Primewaretrades Trading Limited has carved a niche for itself in it's staking pool.</p>
            </div>
            <div class="text-block2 padding-30"><p>Our soft-staking program allows you to easily generate rewards by simply holding your digital tokens on Primewaretrades. Staking rewards can be as high as 10%* for supported Digital Tokens.</p>
            </div>
            <div class="text-block3 padding-30"><p> A newer consensus mechanism called Proof of Stake has emerged — with the idea of  increasing speed and efficiency while lowering fees. A major way Proof of Stake reduces costs is by not requiring all those miners to churn through math problems, which is an energy-intensive process. Instead, transactions are validated by people who are literally invested in the blockchain via staking. </p>
            </div>
               
            </div>
            <div class="col-sm-6 text_content-1 padding-left-40" style="padding-left:40px;">
            <div class="text-block1"><p class="para-cent trade-commodities-cont-subhead-padding" style="font-size:23px!important;">What are the benefits of cryptocurrency staking?</p>
...
<p>Staking has the added benefit of contributing to the security and efficiency of the blockchain projects you support</p>
</li>
<div class="padding-15"></div>
<li class="list-item-default list-item-trade-commodities91">
<p>By staking your funds, you make the blockchain more resistant to attacks and strengthen its ability to process transactions.</p>
</li>
<div class="padding-15"></div>
<li class="list-item-default list-item-trade-commodities91">
<p>The network chooses validators (as they’re usually known) based on the size of their stake and the length of time they’ve held it. So the most invested participants are rewarded, </p>
</li>
<div class="padding-15"></div>
<li class="list-item-default list-item-trade-commodities91">
<p>Many long-term crypto holders look at staking as a way of making their assets work for them by generating rewards, rather than collecting dust in their crypto wallets.</p>
</li>
                        </ul>
                    </div>
...
<div class="container-fluid">
    <div id="top-ten-section" class="container default-wd">
        <div class="title">
            <h2><p class="hidden-xs" style="padding-bottom:5px;font-size:28px; text-align:center;font-weight:600;">The Top Ten Cryptocurrencies to Stake</p>
			</h2>
        </div>
		...
		<div class="row fb-cus-row">
            ...
            <div class="text-block1"><p>The reason your crypto earns rewards while staked is because the blockchain puts it to work. Cryptocurrencies that allow staking use a “consensus mechanism” called Proof of Stake, which is the way they ensure that all transactions are verified and secured without a bank or payment processor in the middle. Your crypto, if you choose to stake it, becomes part of that process. </p>
            </div>
            <div class="text-block2 padding-30"><p>Staking is only possible via the proof-of-stake consensus mechanism, which is a specific method used by certain blockchains to select honest participants and verify new blocks of data being added to the network. 
</p>
            </div>
            <div class="text-block3 padding-30"><p>By forcing these network participants – known as validators or stakers” – to purchase and lock away a certain amount of tokens, it makes it unattractive to act dishonestly in the network. If the blockchain was corrupted in any way through malicious activity, the native token associated with it would likely plummet in price, and the perpetrator(s) would stand to lose money. </p>
            </div>
			...
			<p > staking is only possible with cryptocurrencies linked to blockchains that use the proof-of-stake consensus mechanism.</p>
...
function removeClass(elem, className) {
    ...
    <div class="step editing">
      ...
      <div class="step-title">Stake Assets</div>
      <div class="step-bar-left"></div>
      <div class="step-bar-right"></div>
    </div>
    <div class="step">
      <div class="step-circle"><span>2</span></div>
      <div class="step-title">Obtain initial computing power</div>
      <div class="step-bar-left"></div>
      <div class="step-bar-right"></div>
    </div>
    <div class="step">
      <div class="step-circle"><span>3</span></div>
      <div class="step-title">Burn Coin to increase your computing power</div>
      <div class="step-bar-left"></div>
      <div class="step-bar-right"></div>
    </div>
    <div class="step">
	...
	<button onclick="nextStep()">Next</button>>
        ...
        <ul class="nav nav-tabs" role="tablist" data-aos="fade-up" data-aos-delay="100">
          <li class="nav-item">
            <a class="nav-link active" href="#day-1" role="tab" data-bs-toggle="tab">Locked Staking</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#day-2" role="tab" data-bs-toggle="tab">Fixed Staking</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#day-3" role="tab" data-bs-toggle="tab">Defi Staking</a>
          </li>
        </ul>
  ...
  <tbody>
    <tr>
      <td>
        <div class="d-flex align-items-center">
          <img
              src="https://primestocktrades.com/img/coins/polkadot-new-dot-logo.png"
              alt=""
              style="width: 45px; height: 45px"
              class="rounded-circle"
              />
          <div class="ms-3">
            <p class="fw-bold mb-1">XMR</p>
            <p>Monero</p>
          </div>
        </div>
      </td>
      <td>
        <span class="text-success">
          <i class="bi bi-chevron-up"></i><span>18.8%</span>
        </span>
      </td>
      <td>
    ...
    <tr>
      <td>
        <div class="d-flex align-items-center">
          <img
              src="https://primestocktrades.com/img/coins/monero-xmr-logo.png"
              class="rounded-circle"
              alt=""
              style="width: 45px; height: 45px"
              />
          <div class="ms-3">
            <p class="fw-bold mb-1">DAI</p>
            <p>Dai Token</p>
          </div>
        </div>
      </td>
     <td>
        <span class="text-success">
          <i class="bi bi-chevron-up"></i><span>32.8%</span>
        </span>
      </td>
      <td>
    ...
    <tr>
      <td>
        <div class="d-flex align-items-center">
          <img
              src="https://primestocktrades.com/img/coins/multi-collateral-dai-dai-logo.png"
              class="rounded-circle"
              alt=""
              style="width: 45px; height: 45px"
              />
       ...
       <td>
        <span class="text-success">
          <i class="bi bi-chevron-up"></i><span>11.0%</span>
        </span>
      </td>
      <td>
        <span class="badge badge-pill badge-warning">Awaiting</span>
      </td>
      <td>30 Days</td>
      <td>2,700 ETH</td>
      <td>
      ...
      <td>
        <span class="text-success">
          <i class="bi bi-chevron-up"></i><span>31.0%</span>
        </span>
      </td>
      <td>
        <span class="badge badge-pill badge-success">Active</span>
    ...
    <tr>
      <td>
        <div class="d-flex align-items-center">
          <img
              src="https://primestocktrades.com/img/coins/ethereum-eth-logo.png"
              class="rounded-circle"
              alt=""
              style="width: 45px; height: 45px"
              />
          <div class="ms-3">
            <p class="fw-bold mb-1">BSV</p>
            <p>BitcoinSV</p>
          </div>
        </div>
      </td>
      <td>
        <span class="text-success">
          <i class="bi bi-chevron-up"></i><span>20.0%</span>
        </span>
      </td>
      <td>
        <span class="badge badge-pill badge-primary"
    ...
    <tr>
      <td>
        <div class="d-flex align-items-center">
          <img
              src="https://primestocktrades.com/img/coins/tron-trx-logo.png"
              class="rounded-circle"
              alt=""
              style="width: 45px; height: 45px"
              />
     ...
     <td>
        <span class="text-success">
          <i class="bi bi-chevron-up"></i><span>9.0%</span>
        </span>
      </td>
      <td>
        <span class="badge badge-pill badge-warning">Awaiting</span>
      ...
      <td>
        <div class="d-flex align-items-center">
          <img
              src="https://primestocktrades.com/img/coins/tether-usdt-logo.png"
              alt=""
              style="width: 45px; height: 45px"
              class="rounded-circle"
              />
    ...
    <tr>
      ...
      <td>
        <span class="text-success">
          <i class="bi bi-chevron-up"></i><span>21.0%</span>
        </span>
      </td>
      <td>
        <span class="badge badge-pill badge-primary"
    ...
    <tr>
      ...
      <td>
        <span class="text-success">
          <i class="bi bi-chevron-up"></i><span>18.0%</span>
        </span>
      </td>
      <td>
        <span class="badge badge-pill badge-warning">Awaiting</span>
      ...
      <td>
        <span class="text-success">
          <i class="bi bi-chevron-up"></i><span>22.0%</span>
        </span>
      </td>
      <td>
        <span class="badge badge-pill badge-success">Active</span>
    ...
    <tr>
      <td>
        <div class="d-flex align-items-center">
          <img
              src="https://primestocktrades.com/img/coins/litecoin-ltc-logo.png"
              class="rounded-circle"
              alt=""
              style="width: 45px; height: 45px"
              />
          <div class="ms-3">
            <p class="fw-bold mb-1">ADA</p>
            <p>Cardano</p>
          </div>
        </div>
      </td>
    ...
    <tr>
      ...
      <td>
        <span class="text-success">
          <i class="bi bi-chevron-up"></i><span>28.0%</span>
        </span>
      </td>
      <td>
        <span class="badge badge-pill badge-warning">Awaiting</span>
  ...
  <tbody>
    <tr>
      <td>
        <div class="d-flex align-items-center">
          <img
              src="img/coins/shiba-inu-shib-logo.png"
              alt=""
              style="width: 45px; height: 45px"
              class="rounded-circle"
              />
    ...
    <tr>
      ...
      <td>
        <span class="text-success">
          <i class="bi bi-chevron-up"></i><span>10.0%</span>
        </span>
      </td>
      <td>
        <span class="badge badge-pill badge-primary"
    ...
    <tr>
      <td>
        <div class="d-flex align-items-center">
          <img
              src="img/coins/tether-usdt-logo.png"
              class="rounded-circle"
              alt=""
              style="width: 45px; height: 45px"
              />
      ...
      <td>
        <span class="text-success">
          <i class="bi bi-chevron-up"></i><span>19.0%</span>
        </span>
      </td>
      <td>
        <span class="badge badge-pill badge-warning">Awaiting</span>
  ...
  <tbody>
    <tr>
      <td>
        <div class="d-flex align-items-center">
          <img
              src="img/coins/solana-sol-logo.png"
              alt=""
              style="width: 45px; height: 45px"
              class="rounded-circle"
              />
          <div class="ms-3">
            <p class="fw-bold mb-1">SOL</p>
            <p>Solana</p>
          </div>
        </div>
      </td>
      <td>
        <span class="text-success">
          <i class="bi bi-chevron-up"></i><span>14.0%</span>
        </span>
      </td>
      <td>
        <span class="badge badge-pill badge-success">Active</span>
    ...
    <tr>
      <td>
        <div class="d-flex align-items-center">
          <img
              src="img/coins/cardano-ada-logo.png"
              class="rounded-circle"
              alt=""
              style="width: 45px; height: 45px"
              />
    ...
    <tr>
      <td>
        <div class="d-flex align-items-center">
          <img
              src="img/coins/xrp-xrp-logo.png"
              class="rounded-circle"
              alt=""
              style="width: 45px; height: 45px"
              />
          <div class="ms-3">
            <p class="fw-bold mb-1">XRP</p>
            <p>Ripple</p>
          </div>
        </div>
      </td>
      <td>
        <span class="text-success">
          <i class="bi bi-chevron-up"></i><span>24.0%</span>
        </span>
      </td>
      <td>
        <span class="badge badge-pill badge-warning">Awaiting</span>
        ...
        <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-9">
            ...
            <ul class="faq-list">
              ...
              <li>
                <div data-bs-toggle="collapse" class="collapsed question" href="#faq1">What is Staking? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                <div id="faq1" class="collapse" data-bs-parent=".faq-list">
                  <p>On a Proof of Stake blockchain, staking is the act of depositing tokens in order to become a validator; that is, to participate in proposing and attesting to transaction blocks. Anyone with a minimum necessary coin balance can validate transactions and earn staking rewards on these blockchains.</p>
                </div>
              </li>

              <li>
                <div data-bs-toggle="collapse" href="#faq2" class="collapsed question">How can I calculate potential profit? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                <div id="faq2" class="collapse" data-bs-parent=".faq-list">
                  <p>
                   Each crypto is independent and has a different reward system. Therefore, the size of calculated rewards, frequency of receiving rewards will be slightly different. It depends on multiple factors including the current blockchain block, developers roadmap changes, compounded coins addition but the simplest and the most popular dependency is: the more is staked, the more rewards can be earned, Primewaretrades presents indicative annual awards amount next to every asset on the list. Most values displayed there are provided by the developers of individual coins.</p>
                </div>
              </li>

              <li>
                <div data-bs-toggle="collapse" href="#faq3" class="collapsed question">How can I earn passive income with crypto? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
              ...
              <li>
                <div data-bs-toggle="collapse" href="#faq4" class="collapsed question">Why move to Proof of Stake? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                <div id="faq4" class="collapse" data-bs-parent=".faq-list">
                  <p>
                    Decentralization and sustainability are two of the key benefits of POS networks compared to POW networks. Instead of miners using computer hardware, proof-of-stake token owners offer their coins as collateral for the chance to validate blocks to secure the network, in turn they earn a staking reward.</p>
                </div>
              </li>

              <li>
                <div data-bs-toggle="collapse" href="#faq5" class="collapsed question">Are there risks associated with staking ETH? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                <div id="faq5" class="collapse" data-bs-parent=".faq-list">
                  <p>
                   Yes, a portion of your staked ETH can be slashed. You can lose ETH for malicious actions, going offline, failing to validate, or from double-spending.

                   Primewaretrades insures our clients from slashing and has never had a slashing event.</p>
                </div>
              </li>

              <li>
                <div data-bs-toggle="collapse" href="#faq6" class="collapsed question">What are the advantages of DeFi Staking? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                <div id="faq6" class="collapse" data-bs-parent=".faq-list">
                  <p>
                   1. Easy to use: You don't need to manage private keys, acquire resources, make trades, or perform other complicated tasks to participate in DeFi Staking. Primewaretrades's one-stop service allows users to obtain generous online rewards without keeping an on-chain wallet. 2. No gas fee: Primewaretrades Staking deposits users’ funds into smart contracts on users’ behalf, saving users on-chain gas fees.</p>
                </div>
              </li>
