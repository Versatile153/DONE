...
Route::get('/admin_fund',[DashboardController::class,'admin_fund']);
...
Route::get('show/add13/{id}',[PayMentController::class,'add13']);
Route::get('show/add14/{id}',[PayMentController::class,'add14']);
Route::get('show/add15/{id}',[PayMentController::class,'add15']);
Route::get('show/add16/{id}',[PayMentController::class,'add16']);
Route::get('show/add17/{id}',[PayMentController::class,'add17']);
Route::get('show/add18/{id}',[PayMentController::class,'add18']);
Route::get('show/add19/{id}',[PayMentController::class,'add19']);
Route::get('show/add20/{id}',[PayMentController::class,'add20']);
Route::get('show/add21/{id}',[PayMentController::class,'add21']);
Route::get('show/add22/{id}',[PayMentController::class,'add22']);
...
Route::get('/home', [App\Http\Controllers\HomeController::class, 'index'])->name('home');
Route::get('/fa',[PayMentController::class,'fa']);
Route::get('/log',[PayMentController::class,'log']);
